...
@Entity @Table(name="skill_file_index") public class SkillFileIndexEntity extends BaseJpaEntity{
 ...
 public String getRelativePath(){return relativePath;}public int getSourceRevision(){return sourceRevision;}public String getFileSource(){return fileSource;}public boolean isEditable(){return editable;}public long getSizeBytes(){return sizeBytes;}public String getFileType(){return fileType;}public String getMediaType(){return mediaType;}
}
