...
@Entity @Table(name="skill_source_revision") public class SkillSourceRevisionEntity extends BaseJpaEntity{
 ...
 public void complete(String key,String digest,long bytes){objectKey=key;sha256=digest;sizeBytes=bytes;}
 public int getRevisionNo(){return revisionNo;} public String getObjectKey(){return objectKey;} public String getSha256(){return sha256;} public long getSizeBytes(){return sizeBytes;}
}
