...
@Entity@Table(name="skill_review")public class SkillReviewEntity extends BaseJpaEntity{
 ...
 @Enumerated(EnumType.STRING)@Column(nullable=false,length=32)private ReviewStatus status;@ManyToOne(fetch=FetchType.LAZY,optional=false)@JoinColumn(name="submitter_id")private IamUserEntity submitter;
