...
public class WorkflowController {
 ...
 @GetMapping("/skill-versions/{id}/download") ResponseEntity<org.springframework.core.io.ByteArrayResource> download(@PathVariable Long id,@RequestParam(defaultValue="CODEBUDDY")String platform,@RequestParam(defaultValue="ANY")String osType,Authentication a){var result=downloads.download(id,platform,osType);downloadAudit.record((Long)a.getPrincipal(),null,null,"skill-version/"+id+"/"+platform+"/"+osType);return result;}
